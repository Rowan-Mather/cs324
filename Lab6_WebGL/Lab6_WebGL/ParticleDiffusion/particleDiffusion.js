...
var colours = [false, false, false, false];
...
window.onload = function init() {
    ...
    gl.uniform4f( gl.getUniformLocation(program2, "color"), 0., 0., 0.9, 1.0);
    ...
    //gl.bufferData(gl.ARRAY_BUFFER, numPoints, gl.STATIC_DRAW);
    //gl.bufferSubData(gl.ARRAY_BUFFER, 0, flatten(colours));
    //gl.bufferSubData(gl.ARRAY_BUFFER, 32+8*numPoints, flatten(texCoord));

    //cBufferId = gl.createBuffer();
    //gl.bufferData(gl.ARRAY_BUFFER, numPoints, gl.STATIC_DRAW);
    //gl.bufferSubData(gl.ARRAY_BUFFER, 0, flatten(colours));
    //gl.bufferSubData(gl.ARRAY_BUFFER, numPoints, flatten(texCoord));
    ...
    //gl.uniform4f( gl.getUniformLocation(program1, "betterIdea"), 0.1, 0.1, 0.1, 0.0 );
...
// render to display
    ...
    gl.bindFramebuffer(gl.FRAMEBUFFER, null); //unbinding buffer
